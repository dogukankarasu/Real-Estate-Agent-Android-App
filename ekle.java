...
public class ekle extends AppCompatActivity {
    ...
    private  EditText txt_ctg,txt_typ,txt_adr,txt_prc,txt_rm,txt_sz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_insrt=(Button) findViewById(R.id.btn_updt);

        btn_insrt.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void insert(){
     ...
     Call<ResponseBody> call= RetrofitClient
             .getInstance()
             .getApi()
             .createAdvertise(category,type,adress,price,room,size);
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    String s=response.body().string();
                    Toast.makeText(ekle.this,s,Toast.LENGTH_LONG).show();
                }catch (IOException e){
                    e.printStackTrace();
                }
            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(ekle.this,t.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
